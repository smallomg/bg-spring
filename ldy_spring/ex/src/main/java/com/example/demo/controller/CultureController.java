...
public class CultureController {
	...
	@GetMapping("/p2")
	public String getCultureList2(Model model) {
		try {
			...
			GyeongnamCultureListResponseDTO dto2 = mapper2.readValue(jsonResponse2, GyeongnamCultureListResponseDTO.class);
			// JSON 문자열 -> 자바 객체로 변환
			
			
			List<Item> itemList2 = dto2.getGyeongnamculturallist().getBody().getItems().getItem();
			// System.out.println("파싱된 itemList 크기: " + itemList.size());
